...
@interface TradeAlertsView ()

@end

@implementation TradeAlertsView
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    popup.delegate = self;
    [UIView transitionWithView:self.view.window duration:0.3 options:UIViewAnimationOptionBeginFromCurrentState animations:^{
